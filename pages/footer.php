            ...
            <div class="single_footer widget">
               <div class="single_footer_widget_inner">
                  <div class="footer_logo">
                     <a href="index.php"><img src="assets/img/logo/AS.png" alt=""></a>
                  </div>
                  <div class="footer_content">
                     <p>Địa chỉ: 273 An Dương Vương - Phường 3 - Quận 5 - TP Hồ Chí Minh </p>
                     <p>Điện thoại: 0222 444 875.</p>
                     <p>Email:  BAKA@gmail.com</p>
                  </div>
         ...
         <div class="row">
            <div class="col-lg-6 col-md-6 col-xs-12">
               <div class="copyright_text">
                  <p>Copyright 2018 <a href="#">BAKA STORE</a>. All Rights Reserved</p>
               </div>
            </div>
            <div class="col-lg-6 col-md-6 col-xs-12">
