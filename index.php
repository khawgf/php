    ...
    <body>
                ...
                <div class="slider_area">
                    <div class="slider_list  owl-carousel">
                        <div class="single_slide" style="background-image: url(assets/img/slider/slide1.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <div class="single_slide" style="background-image: url(assets/img/slider/slide2.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="assets/img/banner/erf.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="assets/img/banner/banner-thoi-trang-nam.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="single_banner banner_three">
                                    <a href="#">
                                        <img src="assets/img/banner/kli.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="section_title space_2 text-left">
                                     ...
                                     <div class="home_shop_product text-right">
                                        <ul class="product-tab-list nav d-flex flex-wrap justify-content-end" role="tablist">
                                            ...
                                            <li><a href="#organics" data-toggle="tab" role="tab" aria-selected="false" aria-controls="organics">Quần </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div> 
